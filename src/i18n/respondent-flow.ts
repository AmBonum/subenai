...
// Mirrors `src/i18n/governance.ts` — synchronous resolver over the
// per-namespace Slovak JSON.
import skRespondentFlow from "./locales/sk/respondent-flow.json";

type Json = string | { [k: string]: Json };

const root = skRespondentFlow as Json;
