...
const TOPIC_SLUGS: Record<string, string> = {
  "kontakt.topic_tech_subject": "tech",
  "kontakt.topic_content_subject": "content",
  "kontakt.topic_sponsor_subject": "sponsor",
  "kontakt.topic_gdpr_subject": "gdpr",
  "kontakt.topic_press_subject": "press",
  "kontakt.topic_other_subject": "other",
};
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <section className="mb-10 rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
          ...
          <a
            data-testid="contact-main-email-link"
          ...
          <ul data-testid="contact-topics-list" className="mt-4 grid gap-3 sm:grid-cols-2">
            {TOPICS.map((topic) => (
              <li key={topic.subjectKey}>
                <a
                  data-testid={`contact-topic-link-${TOPIC_SLUGS[topic.subjectKey]}`}
        ...
        >
          ...
          <p className="mt-4 leading-relaxed">
            ...
            <a
              data-testid="contact-gdpr-email-link"
