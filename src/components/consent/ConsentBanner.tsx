      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-4 px-4 py-4 sm:px-6 md:flex-row md:items-center md:gap-6 md:py-5">
        <div className="flex-1 text-sm leading-relaxed">
          ...
          >
            {t("banner.title")}
            <span
              data-testid="consent-banner-badge"
              className="ml-2 rounded-full bg-primary/15 px-2 py-0.5 text-[10px] font-normal text-primary"
            >
          ...
          <p
            ...
            data-testid="consent-banner-body"
            className="mt-1 text-muted-foreground"
          >
            {t("banner.description")}{" "}
            <Link
              to="/cookies"
              data-testid="consent-banner-cookies-link"
            ...
            <Link
              to="/privacy"
              data-testid="consent-banner-privacy-link"
              className="underline underline-offset-2 hover:text-foreground"
            >
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap md:flex-nowrap">
          <Button
            ...
            data-testid="consent-banner-settings-button"
          ...
          <Button
            ...
            size="sm"
            onClick={rejectAll}
            data-testid="consent-banner-reject-all"
