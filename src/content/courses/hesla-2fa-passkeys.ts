...
export const hesla2faPasskeysCourse: Course = {
  ...
  sections: [
    ...
    },
    {
      ...
      commentary: `Bitwarden je open-source, auditovaný a zdarma na všetkých zariadeniach. Platená verzia (10 $/rok) pridáva integrované 2FA. Alternatívy: 1Password (39 $/rok, krajšie používateľské rozhranie), Proton Pass (od Proton Mailu, súčasť Proton Unlimited).`,
    },
    {
      kind: "example",
      ...
      commentary: `2FA cez aplikáciu je oveľa bezpečnejšie ako 2FA cez SMS — útok SIM swap (prepísanie tvojho čísla na cudziu SIM kartu) ti SMS ukradne, overovaciu aplikáciu nie. Pre kritické účty (Gmail, banka, hlavné heslo Bitwardenu) zapni 2FA vždy.`,
    },
    {
      kind: "example",
      ...
      commentary: `YubiKey je zlatý štandard pre 2FA — odolný proti phishingu, na rozdiel od 6-miestnych kódov. Podporuje ho Gmail, Microsoft, GitHub, Facebook, AWS aj Bitwarden. Pre bežného používateľa luxus, pre IT odborníka alebo finančníka nutnosť.`,
    },
    {
      kind: "example",
      ...
      commentary: `Passkey je v podstate kryptografický kľúč viazaný na tvoje zariadenie a biometriu. Nedá sa zneužiť phishingom, nedá sa ukradnúť z databázy (ani neexistuje na serveri v plnej podobe). V roku 2026 ho podporuje Google, Apple, Microsoft, Amazon, GitHub aj eBay.`,
    },
    {
      kind: "checklist",
      ...
      items: [
        {
          good: true,
          text: `Hlavné heslo do správcu hesiel: 4 – 6 náhodných slov + číslo + symbol („KrabicaVlakÚvodom42!"). Zapíš na papier, daj do trezora.`,
        },
        {
          good: true,
        ...
        {
          good: true,
          text: "2FA zapnuté cez overovaciu aplikáciu na: Gmail, banka, Facebook, Instagram, GitHub, Bitwarden, Discord.",
        },
        {
          good: true,
    ...
    {
      kind: "redflags",
      heading: "8 znakov, že tvoja hygiena hesiel je v roku 2015",
      flags: [
        `Rovnaké heslo používaš na viacero účtov (banka, e-mail, e-shop).`,
        `Heslo obsahuje meno, dátum narodenia, mená detí či domáceho miláčika.`,
        `2FA máš len cez SMS, nie cez overovaciu aplikáciu.`,
        `Heslá si pamätáš v hlave — to znamená, že sú slabé alebo opakované.`,
        `Heslá máš v Chrome či Safari bez hlavného hesla zariadenia.`,
        ...
        `Tvoja záložná (recovery) e-mailová adresa je rovnaká ako primárna — pri kompromitácii hlavnej prídeš o všetko.`,
      ],
    },
    {
      kind: "do_dont",
      heading: "Pravidlá hygieny hesiel 2026",
      do: [
    ...
    },
    {
      ...
      story: `Pošta-SK e-mailom oznámi, že tvojmu obľúbenému e-shopu unikla databáza. Tvoj e-mail + heslo sú teraz na dark webe (skrytá časť internetu, kde sa obchoduje s ukradnutými údajmi). Heslo používaš aj na Gmail a Bitwarden.`,
      right_action: `Najprv zmeň heslo na Gmail (najkritickejšie — cez Gmail sa resetuje všetko ostatné). Potom hlavné heslo Bitwardenu. Potom pomocou Bitwardenu prejdi 10 najdôležitejších účtov (banka, Facebook, Instagram, Apple, Microsoft) a každému daj nové 20-znakové heslo. Zapni 2FA všade, kde ešte nie je. Skontroluj haveibeenpwned.com — uvidíš, ktoré ďalšie úniky sa ťa týkajú. Celkový čas: 1 hodina, výsledok: do týždňa máš lepšiu hygienu hesiel ako 95 % populácie.`,
    },
  ],
  sources: [
