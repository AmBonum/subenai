...
const ROUTES: readonly Route[] = [
  ...
  { path: "/app/insights?tab=digest", slug: "insights-digest" },
  { path: "/app/insights?tab=recommendations", slug: "insights-recommendations" },
  { path: "/app/insights?tab=retest", slug: "insights-retest" },
  { path: "/app/insights?tab=peer", slug: "insights-peer" },
