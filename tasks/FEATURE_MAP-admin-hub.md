...
| `routes/admin/tests.$testId.tsx` | `src/routes/admin/tests.$testId.tsx` | AH-5.8 | Done | see `git log` |
...
| `routes/admin/quick-test.tsx` | `src/routes/admin/quick-test.tsx` | AH-9.5 | Done | see `git log` |
| `routes/admin/share-card.tsx` | `src/routes/admin/share-card.tsx` | AH-9.6 | Done | see `git log` |
...
| `routes/admin/navigation.tsx` | `src/routes/admin/navigation.tsx` | AH-9.4 | Done | see `git log` |
...
| `components/admin/TestEditor.tsx` | `src/components/admin/TestEditor.tsx` | AH-5.8 | Done | see `git log` |
